...
export const StudentDashboard = () => {
  ...
  return (
    <div className={styles.container}>
            ...
            <div className={styles.aiContent}>
              <div className={styles.aiStatus}>
                ...
                <span className={styles.statusLabel}>
                  {t("student.dashboard.aiTutorStatus", "AI Tutor")}
                </span>
              </div>
      ...
      {gamification && (
        <section className={styles.sectionGamification}>
          <Card>
            <CardBody>
              <h3
                style={{
              ...
              >
                ...
                {t("student.dashboard.achievements", "Your Badges and Stats")}
              </h3>
          ...
          <Card>
            <CardBody>
              <h3 style={{ marginBottom: "1rem" }}>
                {t("student.dashboard.liders", "Global Leaderboard (Top XP)")}
              </h3>
      ...
      <section className={styles.sectionBlock}>
        ...
        {isLoading ? (
          <div className={styles.loadingState}>
            {t("student.dashboard.loading", "Loading your dashboard...")}
          </div>
        ) : courses.length === 0 ? (
                ...
                <div key={course.id} className={styles.recommendationItem}>
                  ...
                  <div className={styles.recommendationAction}>
                    <Button
                      ...
                      onClick={() => navigate("/student/catalog")}
                    >
                      {t("student.dashboard.viewCatalog", "View Catalog")}
                    </Button>
                  </div>
                </div>
              ))
