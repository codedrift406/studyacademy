    ...
    <div>
      <div className={styles.sectionHeader}>
        <div>
          ...
          >
            {t("teacher.welcome", "Welcome back, {name}", {
              name: user.name || "Teacher",
            })}
          </h1>
          <p className={styles.headerText}>
            {t("teacher.workspace", "Your teaching workspace is ready.")}
          </p>
        </div>
          ...
          style={
            {
              ...
              "--glow-stroke": "rgba(99, 102, 241, 0.4)",
            } as any
          }
        >
          <CardBody>
            <div className={styles.statLabel}>
              <Users size={20} /> {t("teacher.totalStudents", "Total Students")}
            </div>
            {isLoading ? (
            ...
            <div className={styles.statChange}>
              <TrendingUp size={14} /> {overview?.totalEnrollments || 0}{" "}
              enrollments
            </div>
          </CardBody>
        </Card>
          ...
          style={
            {
              ...
              "--glow-stroke": "rgba(168, 85, 247, 0.4)",
            } as any
          }
        >
          <CardBody>
            <div className={styles.statLabel}>
              <BookOpen size={20} />{" "}
              {t("teacher.activeCourses", "Active Courses")}
            </div>
            {isLoading ? (
            ...
            <div className={styles.statChange}>
              {overview?.aiCourseCount || 0} AI assisted
            </div>
          </CardBody>
        </Card>
        <Card
          ...
          style={
            {
              ...
              "--glow-stroke": "rgba(244, 63, 94, 0.4)",
            } as any
          }
        >
          <CardBody>
            <div className={styles.statLabel}>
              <Users size={20} style={{ color: "#f43f5e" }} />{" "}
              {t("teacher.riskGroup", "Risk Group")}
            </div>
            {isLoading ? (
              <Skeleton width="40%" height="2rem" />
            ) : (
              <div className={styles.statValue} style={{ color: "#f43f5e" }}>
                {overview?.riskCount || 0}
              </div>
            )}
            <div className={styles.statChange} style={{ color: "#f43f5e" }}>
              Needs attention
            </div>
          </CardBody>
        </Card>
          ...
          style={
            {
              ...
              "--glow-stroke": "rgba(16, 185, 129, 0.4)",
            } as any
          }
        >
          <CardBody>
            <div className={styles.statLabel}>
              ...
              {t("teacher.courseHealth", "Course Health")}
            </div>
            {isLoading ? (
            ...
            <div className={styles.statChange} style={{ color: "#10b981" }}>
              Avg Score: {overview?.averageScore ?? 0}%
            </div>
          </CardBody>
        </Card>
      </div>
      ...
      <div className={styles.analyticsTier}>
        <div className={styles.chartContainer}>
          ...
          >
            <h3 style={{ margin: 0 }}>
              {t("teacher.analyticsPulse", "Analytics Pulse")}
            </h3>
            <div style={{ fontSize: "0.8rem", color: "var(--text-secondary)" }}>
              {t("teacher.PerformanceMetrics", "Performance Metrics")}
            </div>
          </div>
        ...
        <div className={styles.quickHub}>
          <Card style={{ flex: 1 }}>
            <CardBody>
              ...
              >
                {t("teacher.courses.viewAll", "All Courses")}
              </Button>
            </CardBody>
          </Card>
        </div>
