      ...
      <nav className={styles.navbar}>
        ...
        <div className={styles.navLinks}>
          ...
          <a href="#solutions" className={styles.navLink}>
            {t("landing.nav.solutions", "Solutions")}
          </a>
        </div>
        <div className={styles.controls}>
          ...
          <div className="neon-border-wrapper" style={{ borderRadius: "12px" }}>
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className={`${styles.btnPrimaryheader} `}
              style={{
        ...
        <div className={styles.heroContent}>
          ...
          <motion.h1
            ...
            dangerouslySetInnerHTML={{
              __html: t(
                "landing.hero.title",
                "The Operating System<br/>for Next-Gen Learning.",
              ),
            }}
          />
          ...
          >
            {t(
              ...
              "Empower your students with AI-driven adaptive learning, immersive RPG game modes, and deep enterprise analytics. Welcome to the future of education.",
            )}
          </motion.p>
          ...
          >
            <button
              ...
              onClick={() => navigate("/auth")}
            >
              {t("landing.hero.cta.start", "Get Started Free")}{" "}
              <ArrowRight
                size={18}
                style={{
                  display: "inline",
        ...
        >
          <div
            ...
            style={{
              aspectRatio: "16/9",
              background:
                "linear-gradient(to bottom right, var(--bg-surface), var(--bg-elevated))",
              display: "flex",
            }}
          >
            <div
          ...
          >
            ...
            <div>
              <p style={{ margin: 0, fontWeight: "bold" }}>
                {t("landing.preview.shield", "AI Graded")}
              </p>
              <p
                style={{
                  margin: 0,
              ...
              >
                {t("landing.preview.score", "Score: 98% 🌟")}
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div>
              <p style={{ margin: 0, fontWeight: "bold" }}>
                {t("landing.preview.level", "Level Up!")}
              </p>
              <p
                style={{
                  margin: 0,
              ...
              >
                {t("landing.preview.levelSub", "You reached Level 12")}
              </p>
            </div>
          </motion.div>
        </motion.div>
      ...
      <section id="features" className={styles.features}>
        <div className={styles.sectionHeader}>
          <h2 className={styles.sectionTitle}>
            {t("landing.features.title", "Built for the Modern Learner")}
          </h2>
        ...
        <div className={styles.featureGrid}>
          <motion.div whileHover={{ y: -5 }} className={styles.featureCard}>
            ...
            <h3 className={styles.featureTitle}>
              {t("landing.features.ai.title", "AI-Powered Creation")}
            </h3>
            <p className={styles.featureText}>
              {t(
                "landing.features.ai.desc",
                "Generate entire courses, quizzes, and adaptive learning paths in seconds using advanced language models.",
              )}
            </p>
          </motion.div>
          ...
          <motion.div whileHover={{ y: -5 }} className={styles.featureCard}>
            ...
            <h3 className={styles.featureTitle}>
              {t("landing.features.rpg.title", "RPG Gamification")}
            </h3>
            <p className={styles.featureText}>
              {t(
                "landing.features.rpg.desc",
                "Turn boring curriculum into an interactive 2D map. Students explore islands, earn XP, and unlock chests.",
              )}
            </p>
          </motion.div>
          ...
          <motion.div whileHover={{ y: -5 }} className={styles.featureCard}>
            ...
            <p className={styles.featureText}>
              {t(
                ...
                "Instantly spot struggling students with our risk-scoring algorithms and export beautifully crafted PDF reports.",
              )}
            </p>
          </motion.div>
        </div>
