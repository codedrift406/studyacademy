...
import { Save, Bell, Camera, UserCircle } from "lucide-react";
...
export const ProfilePage = () => {
  ...
  return (
    <div
      className={`glass-panel ${styles.profilePanel}`}
      style={{ display: "grid", gap: "2rem" }}
    >
      <Card interactive>
        <CardBody className={styles.profileCardBody}>
          <div
            style={{
              display: "flex",
              alignItems: "center",
                ...
                <div style={{ position: "relative" }}>
                  ...
                  >
                    {finalAvatarUrl ? (
                      ...
                      // Если URL нет, показываем SVG иконку с теми же размерами
                      <UserCircle
                        style={{
                          width: 100,
                          height: 100,
                          color: "var(--text-secondary)", // Цвет иконки
                          strokeWidth: 1, // Тонкие линии для стиля glassmorphism
                        }}
                      />
                    )}
                  </div>
