...
export const DashboardLayout = ({ children, role }: DashboardLayoutProps) => {
      ...
      ? [
          {
            ...
            label: t("nav.teacher.dashboard", "Overview"),
            icon: <LayoutDashboard size={20} />,
          },
          {
            path: "/teacher/courses",
            label: t("nav.teacher.courses", "My Courses"),
            icon: <BookOpen size={20} />,
          },
          {
            path: "/teacher/create",
            label: t("nav.teacher.create", "Create Course"),
            icon: <PlusCircle size={20} />,
          },
          {
            path: "/teacher/students",
            label: t("nav.teacher.students", "Students"),
            icon: <Users size={20} />,
          },
          {
            path: "/teacher/ai-library",
            label: "AI Library",
      ...
      : [
          {
            ...
            label: t("nav.student.dashboard", "My Learning"),
            icon: <LayoutDashboard size={20} />,
          },
          {
            path: "/student/catalog",
            label: t("nav.student.catalog", "Catalog"),
            icon: <BookOpen size={20} />,
          },
          {
            path: "/student/ai-library",
            label: "AI Library",
            icon: <BrainCircuit size={20} />,
          },
          {
  ...
  const currentTitle =
    navLinks.find((item) => location.pathname.startsWith(item.path))?.label ||
    "Dashboard";
  const initials = (
    user.nickname ||
    user.name ||
  ...
  return (
    <div className={styles.layout}>
      ...
      <div className={styles.appContainer}>
        ...
        >
          <Link className={styles.brand} to="/student/dashboard">
            ...
            <div className={styles.userInfo}>
              <div className={styles.controlCluster}>
                <div
                  ...
                  aria-label={t("layout.language", "Language")}
                >
                  <button
              ...
              {user.avatarUrl ? (
                ...
                <button
                  ...
                  style={{
                    ...
                    cursor: "pointer",
                    borderRadius: "50%",
                    outline: "none", // Убери стандартную обводку, если она мешает стилю glassmorphism
                  }}
                  className={styles.avatar}
                >
                  {initials}
              ...
              <div
                className={`${styles.miniMenu} ${isDropMenu ? styles.miniMenuOpen : ""}`}
              >
                {navLinks.map((link) => {
                  return (
                    <NavLink
